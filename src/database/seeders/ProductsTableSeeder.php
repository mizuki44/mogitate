...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'name' => 'キウイ',
            'price' => '800',
            'image' => 'http://localhost/storage/sample/kiwi.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'http://localhost/storage/sample/strawberry.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'オレンジ',
            'price' => '850',
            'image' => 'http://localhost/storage/sample/orange.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'http://localhost/storage/sample/watermelon.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => 'http://localhost/storage/sample/peach.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => 'http://localhost/storage/sample/muscat.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'http://localhost/storage/sample/pineapple.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'http://localhost/storage/sample/grapes.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'バナナ',
            'price' => '600',
            'image' => 'http://localhost/storage/sample/banana.png',
        ...
        DB::table('products')->insert($param);
         ...
         $param = [
            ...
            'name' => 'メロン',
            'price' => '900',
            'image' => 'http://localhost/storage/sample/melon.png',
